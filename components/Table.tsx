  ...
  return (
    <div className='mt-4 flex flex-col'>
      <div className='overflow-auto rounded-lg border border-gray-200 align-middle'>
            ...
            {!isLoading && total === 0 && !error && (
              <tr>
                <td colSpan={cols.length} className='p-8 text-center'>
                  <p className='mb-1 text-md font-semibold text-gray-900'>No results found</p>
        ...
        <nav
          className='sticky left-0 flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:rounded-b-lg sm:px-5'
